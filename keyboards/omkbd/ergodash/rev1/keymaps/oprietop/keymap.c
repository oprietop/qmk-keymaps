...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_AD] = LAYOUT( /* ADJUST */
     QK_RBT,   MODDH,  QWERTY,  DVORAK, DB_TOGG,  M_WIPE, _______,          _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, \
      M_VER, RGB_M_G, RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_K, _______,          _______, KC_PMNS,   KC_P7,   KC_P8,   KC_P9, KC_PSLS, KC_NUM, \
    RGB_RMD, RGB_HUI, RGB_SAI, RGB_VAI, KC_BRIU, XXXXXXX, _______,          _______,   KC_P0,   KC_P4,   KC_P5,   KC_P6, KC_PDOT, KC_CAPS, \
    RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, KC_BRID, XXXXXXX, _______,          _______, KC_PPLS,   KC_P1,   KC_P2,   KC_P3, KC_PAST, KC_SCRL, \
